                    ...
                    <div className="flex items-center gap-2 px-4">
                        ...
                        <Breadcrumb>
                            <BreadcrumbList>
                                ...
                                <BreadcrumbSeparator />
                                <BreadcrumbItem>Achievement</BreadcrumbItem>
                                <BreadcrumbSeparator />
                                <BreadcrumbItem><BreadcrumbLink href="/achievement/entry">Entry</BreadcrumbLink></BreadcrumbItem>
                                <BreadcrumbSeparator />
                                ...
                                <CardContent>
                                    {filteredActivities.length > 0 ? (
                                        <div className="rounded-md border overflow-auto">
                                            <Table>
                                                <TableHeader>
                                                    <TableRow className="bg-muted/50"><TableHead className="w-[100px]">Activity</TableHead><TableHead>Activity Name</TableHead><TableHead>KPI</TableHead><TableHead>Category</TableHead><TableHead className="text-right">Weight (%)</TableHead><TableHead>Target</TableHead><TableHead>Deliverable</TableHead><TableHead>Actions</TableHead></TableRow>
                                                </TableHeader>
                                                <TableBody>
                                                    {filteredActivities.map((activity) => (
                                                        <TableRow key={activity.id}>
                                                            ...
                                                            <TableCell> {/* <- Tambahkan kolom ini */}
                                                                {ipp?.approval === 'APPROVED' && (
                                                                    <Button
                                                                        size="sm"
                                                                        variant="outline"
                                                                        onClick={() => router.push(`/achievement/entry/${ippId}/${activity.activity}`)}
