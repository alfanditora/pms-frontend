...
export default function ManagementSide() {
    ...
    const fetchIpps = async () => {
        ...
        try {
            ...
            const res = await fetch(`https://pms-database.vercel.app/api/ipp/active/all`, {
                ...
                <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                            <div>
                                <CardTitle className="text-2xl font-bold">IPP Submission</CardTitle>
                                <p className="text-sm text-muted-foreground mt-1">
                                    Manage all users Individual Performance Plan submission
                                </p>
                            </div>
                            {/* Refresh Button */}
                            <Button
                                                    ...
                                                    <TableRow key={ipp.ipp}>
                                                        ...
                                                        <TableCell className="text-center">
                                                            <Button asChild variant="outline" size="sm" className="h-8 px-2">
                                                                <Link href={`/ipp/submission/${ipp.ipp}`}>
